...
<li id="kdbyun"><a href="#hd>변학도</a></li></ul></nav>
<section id="Area"><form id="formld">
 ...
 sName + " '/);%></div>
  <div id="div2" class="class1">
    <label id="id_21" class="class2" for="id22">학번</label>
    <%= request.getParameter("sNumber")%></div>
  <div id="div3">
    <label id="id_31" for="id32">전화</label>
    <%= request.getParameter("sPhone")%></div>
  <div id="div4">
  <footer><p>&copy; 20XX Made by Korea. All rights reversed.</p></footer>
</body></html>
